...
class Postagem:Entidade{
    ...
    static func criarPostagensTeste() -> [Postagem]{
        ...
        postagem1.foto = ImageUtil.imageToNSString64(image: UIImage(named: "4")! )
        ...
        postagem2.foto = ImageUtil.imageToNSString64(image: UIImage(named: "1")! )
        ...
        postagem3.foto = ImageUtil.imageToNSString64(image: UIImage(named: "2")! )
        ...
        postagem4.foto = ImageUtil.imageToNSString64(image: UIImage(named: "3")! )
